						...
						<table class="table no-more-tables table-stipped">
							...
							@foreach($categories as $category)
								<tr>
									...
									{{--								<td class="v-align-middle"><span class="muted">{{ $category->duration }}</span></td>--}}
									<td class="v-align-middle">{{ $status[$category->status] or '' }}</td>
									<td><span class="muted">{{ $category->created_at }}</span></td>
									<td><a class="btn btn-primary btn-sm btn-small" href="{{ route('admin.get-category', $category->id) }}">Edit</a> <a class="btn btn-danger btn-sm btn-small" href="">Delete</a></td>
							...
							<tr>
								<td colspan="4">
									<a href="{{ route('admin.get-category') }}" class="btn btn-primary btn-cons">Add Category</a>
								</td>
							</tr>
							</tbody>
						</table>
