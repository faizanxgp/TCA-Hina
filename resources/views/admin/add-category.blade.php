			...
			<div class="col-md-12 ">
				...
				<div class="grid simple">
					...
					<div class="grid-body no-border">
						...
						<h3>Sector</h3>
						<form method="post" action="{{ route('admin.post-category') }}">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="controls">
											<input class="form-control {{ $errors->has('category') ? 'error' : '' }}" type="text" name="category" value="{{ $category->category or old('category') }}">
										</div>
