						...
						<table class="table no-more-tables table-stipped">
							...
							@foreach($countries as $country)
								<tr>
									...
									<td class="v-align-middle">{{ $country->country }}</td>
									<td class="v-align-middle">{{ $status[$country->status] or '' }}</td>

									<td><span class="muted">{{ $country->created_at }}</span></td>
									<td><a class="btn btn-primary btn-sm btn-small" href="{{ route('admin.get-country', $country->id) }}">Edit</a> <a class="btn btn-danger btn-sm btn-small" href="">Delete</a></td>
							...
							<tr>
								<td colspan="4">
									<a href="{{ route('admin.get-country') }}" class="btn btn-primary btn-cons">Add Country</a>
								</td>
							</tr>
							</tbody>
						</table>
