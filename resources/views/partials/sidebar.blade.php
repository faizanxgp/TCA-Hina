<div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
	...
	<ul>
		<li class="start "><a href="{{ route('home') }}"><i class="material-icons">home</i> <span class="title">Dashboard</span> <span class="selected"></span> </a>

		</li>
		<li>
			<a href="{{ route('my-pins') }}"> <i class="material-icons">panorama_horizontal</i> <span class="title">My Pins</span> <span class="label label-important bubble-only pull-right "></span></a>
		</li>
		<li>
			<a href="{{ route('shared-pins') }}"> <i class="material-icons">panorama_horizontal</i> <span class="title">Shared Pins</span> <span class="label label-important bubble-only pull-right "></span></a>
		</li>
		<li>
			<a href="{{ route('teams') }}"> <i class="material-icons">panorama_horizontal</i> <span class="title">My Teams</span> <span class="label label-important bubble-only pull-right "></span></a>
		</li>
		<li>
			<a href="{{ route('my-inbox') }}"> <i class="material-icons">panorama_horizontal</i> <span class="title">Inbox</span> <span class="label label-important bubble-only pull-right "></span></a>
		</li>
		<li>
			<a href="{{ route('my-profile') }}"> <i class="material-icons">email</i> <span class="title">Profile</span> </a>
		</li>
		{{--<li>
